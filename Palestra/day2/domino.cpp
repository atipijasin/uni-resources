...
void calcola(int facciaTesseraAttuale, int lunghezzaCatenaAttuale)
{
    ...
    // la tessera attuale (mettendola usata=true) alla faccia attuale e aumentando la 
    // lunghezza della catena di 1
    for (int i = 0; i < N; i++)
    {
        ...
        if (!tessereUsate[i])
        {
            ...
            {
                // Se si puo' collegare con la prima faccia, metto la tessera attuale come usata
                tessereUsate[i] = true;
            ...
            {
                // Se si puo' collegare con la seconda faccia, metto la tessera attuale come usata
                tessereUsate[i] = true;
